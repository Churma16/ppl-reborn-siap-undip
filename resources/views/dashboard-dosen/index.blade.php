...
@section('content')
    <div class="container-fluid px-2 px-md-4 mt-6">
        <div class="card card-body mx-3 mx-md-4 mt-n6 mt-4">
                        ...
                        <div class="card card-plain h-100">
                            ...
                            <div class="card-body p-3">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item border-0 ps-0 text-sm"><strong
                                            class="text-dark">Email:</strong> &nbsp; <a href="/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="a6c7cac3c5d2cec9cbd6d5c9c8e6cbc7cfca88c5c9cb">[email&#160;protected]</a>
                                    </li>
                                    <li class="list-group-item border-0 ps-0 text-sm"><strong
