            ...
            <div class="row mx-4 mb-4">
                <div class="card mt-4 border ">
                    ...
                    <div class="card-body ">
                        ...
                        <form method="POST" action="/dashboard-mahasiswa/kelola-khs" enctype="multipart/form-data">
                            @csrf
                            <div class="row border-top pt-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    <p class="card-text  mb-1"><strong>IP Kumulatif:</strong> {{ $ipk }}</p>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="mt-3 mb-1">
                                    ...
                                    <div class="input-group input-group-outline ">
                                        <input type="text" name="ip_semester" id="ip_semester" class="form-control p-2"
                                            placeholder="Masukan IP semester ini *Maks 4.00">
                                    </div>
                                </div>
                                <div class="mt-3 mb-1">
                                    <strong>Upload Scan KHS</strong>
                                    <div class="input-group input-group-outline">
                                        <input type="file" name="file_khs" id="file_khs" class="form-control p-2">
                                    </div>
                                    <ul>
                                        <li>
