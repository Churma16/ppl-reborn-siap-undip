                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="text-secondary text-xs font-weight-bold">
                                                {{ $mahasiswa->skripsiTerakhir->created_at->format('d M Y') }}</span>
                                        </td>

                                        {{-- PERIODE (GABUNGAN TGL MULAI & SELESAI) --}}
                                        <td class="align-middle text-center">
                                            @if ($mahasiswa->skripsiTerakhir)
                                                <span class="text-secondary text-xs font-weight-bold d-block">
                                                    {{ $mahasiswa->skripsiTerakhir->tanggal_mulai_formatted }}
                                                </span>
                                                <span class="text-secondary text-xxs">s.d.</span>
                                                <span class="text-secondary text-xs font-weight-bold d-block">
                                                    {{ $mahasiswa->skripsiTerakhir->tanggal_selesai_formatted ?? 'Belum Ditentukan' }}
                                                </span>
                                            @else
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            ...
                                            @if ($mahasiswa->skripsiTerakhir == null)
                                                <span class="badge badge-sm bg-gradient-secondary">Belum PKL</span>
                                            @elseif ($mahasiswa->skripsiTerakhir->status_skripsi == 'Lulus')
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            @if ($mahasiswa->skripsiTerakhir && $mahasiswa->skripsiTerakhir->file_pkl)
                                                <a href="{{ asset('storage/' . $mahasiswa->skripsiTerakhir->file_pkl) }}"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body p-4">
                                                        ...
                                                        <div class="card-body p-3 d-flex align-items-center">
                                                            ...
                                                            <div class="ms-auto text-end d-none d-md-block">
                                                                ...
                                                                <p class="text-xxs text-secondary mb-0">
                                                                    ...
                                                                    -{{ $mahasiswa->skripsiTerakhir->tanggal_selesai_formatted ?? 'TBA' }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="timeline timeline-one-side" style="position: relative;">
                                                        @foreach ($mahasiswa->skripsi as $skripsi)
                                                            <div class="timeline-block mb-3">
                                                                <span class="timeline-step">
                                                                    <i
                                                                        class="material-icons text-{{ $skripsi->status_konfirmasi->color() }} text-gradient">{{ $skripsi->status_konfirmasi->icon() }}</i>
                                                                </span>
                                                                <div class="timeline-content" style="max-width: 100%;">
                                                                    <div class="d-flex justify-content-between pt-1 mb-2">
                                                                        <span
                                                                            class="text-dark text-sm font-weight-bold">Progress
                                                                            Ke-{{ $skripsi->progress_ke }}</span>
                                                                        <span
                                                                            class="badge badge-sm bg-gradient-{{ $skripsi->status_konfirmasi->color() }}">{{ $skripsi->status_konfirmasi->value }}</span>
                                                                    </div>

                                                                    <div class="p-3 border rounded bg-gray-100">
                                                                        <p class="text-sm text-secondary mb-2">
                                                                            {{ $skripsi->rincian_progress ?? '(Tidak Ada Rincian)' }}
                                                                        </p>
                                                                        <div class="d-flex align-items-center mt-2">
                                                                            <small
                                                                                ...
                                                                                {{ $skripsi->created_at->format('d M Y H:i') }}
                                                                            </small>
                                                                            <a href="{{ $skripsi->file_skripsi }}"
